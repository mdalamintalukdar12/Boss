...
try:
    os.system('clear')
    xnx = requests.get('https://github.com/mdalamintalukdar12/Numan/blob/main/Numan.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/mdalamintalukdar12/Numan/blob/main/Numan.txt').text    
    if id in httpCaht:
